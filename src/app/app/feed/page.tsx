...
import CommunityFollow from "@/components/features/community-follow";
...
export default async function FeedPage() {
  ...
  // 2. Fetch profiles available to follow (excluding self)
  ...
  // 3. Compile activities if followedIds are present
  ...
  if (followedIds.length > 0) {
    ...
    // Fetch followed users finished ratings to attach
